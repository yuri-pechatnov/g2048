...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.activity_main, container, false)  // todo: rename to fr_main
        ...
        val rowsHolderLayout = LinearLayout(activity)
        rowsHolderLayout.orientation = LinearLayout.VERTICAL
        rowsHolderLayout.layoutParams = LinearLayout.LayoutParams(
        ...
        playGridLayout!!.setOnTouchListener(object: OnSwipeTouchListener(context!!) {
...
//            recreate()
            //
            getFragmentManager()!!.beginTransaction() // todo: нужно getSupportFragmentManager вместо getFragmentManager!!!!
...
//                updateScore()
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        Log.e("anima", "ori ${newConfig.orientation} ${activity!!.requestedOrientation}")
    ...
    fun createCell(value: Int, parent: View? = null): View {
        ...
        val cellView = TextView(activity)
    ...
    fun ejectSavingSizeAndPos(item: View, group: ViewGroup, root: ViewGroup) {
        item.layoutParams = ViewGroup.LayoutParams(item.measuredWidth, item.measuredHeight)
